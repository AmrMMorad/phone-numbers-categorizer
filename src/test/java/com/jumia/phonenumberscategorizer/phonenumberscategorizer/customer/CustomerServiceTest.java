...
class CustomerServiceTest {
    ...
    public void return_success_for_empty_database_default_parameters() {
        ...
        CustomerPageDTO customerPageDTO = service.getCustomers(false, "", "", "", 0, 10);
	...
	@Test
    public void return_record_for_one_record_database_filter_by_country_name() {
		Page<Customer> customerPage = new PageImpl<>(Collections.singletonList(insertCustomer(1L, "Amr Morad", "(237) 1234567")));
		
		doReturn(customerPage).when(repository).findAll(any(PageRequest.class));

        CustomerPageDTO customerPageDTO = service.getCustomers(false, "Cameroon", "", "", 0, 10);
        assertThat(customerPageDTO.getCustomers().size()).isEqualTo(1);
        assertThat(customerPageDTO.getTotalPages()).isEqualTo(1);
        assertThat(customerPageDTO.getPageSize()).isEqualTo(1);
		assertThat(customerPageDTO.getFilteredPageSize()).isEqualTo(1);
	...
	@Test
    public void return_record_for_one_record_database_filter_code_number() {
		Page<Customer> customerPage = new PageImpl<>(Collections.singletonList(insertCustomer(1L, "Dominique mekontchou", "(237) 691816558")));
		
		doReturn(customerPage).when(repository).findAll(any(PageRequest.class));

        CustomerPageDTO customerPageDTO = service.getCustomers(false, "", "237", "691816558", 0, 10);
        assertThat(customerPageDTO.getCustomers().size()).isEqualTo(1);
        assertThat(customerPageDTO.getTotalPages()).isEqualTo(1);
        assertThat(customerPageDTO.getPageSize()).isEqualTo(1);
		assertThat(customerPageDTO.getFilteredPageSize()).isEqualTo(1);
    ...
    public void return_empty_for_one_record_database_filter_code_number() {
        ...
        CustomerPageDTO customerPageDTO = service.getCustomers(false, "", "237", "6916558", 0, 10);
        assertThat(customerPageDTO.getCustomers().size()).isEqualTo(0);
        assertThat(customerPageDTO.getTotalPages()).isEqualTo(1);
        assertThat(customerPageDTO.getPageSize()).isEqualTo(1);
		assertThat(customerPageDTO.getFilteredPageSize()).isEqualTo(0);
	...
	@Test
    public void return_empty_for_one_record_database_filter_by_country_name() {
		Page<Customer> customerPage = new PageImpl<>(Collections.singletonList(insertCustomer(1L, "Amr Morad", "(237) 1234567")));
		
		doReturn(customerPage).when(repository).findAll(any(PageRequest.class));

        CustomerPageDTO customerPageDTO = service.getCustomers(false, "no country", "", "", 0, 10);
        assertThat(customerPageDTO.getCustomers().size()).isEqualTo(0);
        assertThat(customerPageDTO.getTotalPages()).isEqualTo(1);
        assertThat(customerPageDTO.getPageSize()).isEqualTo(1);
		assertThat(customerPageDTO.getFilteredPageSize()).isEqualTo(0);
    ...
    public void return_one_record_for_multiple_records_database() {
		...
		customers.add(insertCustomer(1L, "Amr Morad", null));
    ...
    public void return_empty_record_for_multiple_records_database_filter_country() {
        ...
        CustomerPageDTO customerPageDTO = service.getCustomers(true, "MOROCCO", "", "", 0, 10);
        assertThat(customerPageDTO.getCustomers().size()).isEqualTo(0);
        assertThat(customerPageDTO.getTotalPages()).isEqualTo(1);
        assertThat(customerPageDTO.getPageSize()).isEqualTo(2);
		assertThat(customerPageDTO.getFilteredPageSize()).isEqualTo(0);
	...
	@Test
    public void return_empty_record_for_multiple_records_database_filter_local_number() {
		List<Customer> customers = new ArrayList<>();
		customers.add(insertCustomer(1L, "Amr Morad", null));
		customers.add(insertCustomer(2L, "Dominique mekontchou", "(237) 691816558"));
        ...
        CustomerPageDTO customerPageDTO = service.getCustomers(true, "Cameroon", "237", "111", 0, 10);
        assertThat(customerPageDTO.getCustomers().size()).isEqualTo(0);
        assertThat(customerPageDTO.getTotalPages()).isEqualTo(1);
        assertThat(customerPageDTO.getPageSize()).isEqualTo(2);
		assertThat(customerPageDTO.getFilteredPageSize()).isEqualTo(0);
	...
	@Test
    public void return_empty_record_for_unknown_phone_database_filter_local_number() {
		Page<Customer> customerPage = new PageImpl<>(Collections.singletonList(insertCustomer(1L, "Amr Morad", "012 3456789")));
